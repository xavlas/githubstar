        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-2 bg-surface hover:bg-surface-hover rounded-xl border border-border transition-colors text-text-main"
          ...
          <div className="flex-1">
            <div className="mb-6 flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 text-sm text-text-muted bg-surface px-3 py-1.5 rounded-full border border-border">
            ...
            {error ? (
              ...
              <div className="text-center py-20 bg-surface/50 rounded-xl border border-border border-dashed">
                ...
                <h3 className="text-lg font-medium text-text-main">No trending repositories found</h3>
                <p className="text-text-muted mt-1">Try selecting a different language or timeframe.</p>
              </div>
            ) : (
              <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-lg font-semibold text-primary group-hover:text-primary-hover truncate max-w-[200px] sm:max-w-md">
                          <span className="font-normal text-text-muted">{repo.owner.login} / </span>
                          {repo.name}
                        </h3>
                      </div>
                    </div>
                    
                    <p className="text-text-muted text-sm mt-3 mb-5 line-clamp-2 pl-11">
                      {repo.description || "No description provided."}
                    </p>

                    <div className="flex flex-wrap items-center gap-4 text-xs font-medium text-text-muted pl-11">
                      {repo.language && (
                      ...
                      <div className="flex items-center gap-1 hover:text-text-title transition-colors">
